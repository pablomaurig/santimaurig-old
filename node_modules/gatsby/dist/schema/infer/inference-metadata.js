...
const updateValueDescriptor = ({
  ...
  const ret = _updateValueDescriptor(nodeId, key, value, operation, descriptor, path, typeName);

  path.pop();
  return ret;
};

const _updateValueDescriptor = (nodeId, key, value, operation, descriptor, path, typeName) => {
